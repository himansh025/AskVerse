    ...
    <div className="max-w-7xl mx-auto relative">
      ...
      {feed.length === 0 ? (
        <div className="text-center py-20 glass rounded-2xl">
          <div className="w-32 h-32 mx-auto mb-6 rounded-full  flex items-center justify-center float-animation" style={{ backgroundColor: "#8f0752" }}>
          ...
          <div className="flex gap-4 justify-center">
            <Button
              ...
              variant="secondary"
              className="flex items-center text-white gap-2" style={{ backgroundColor: "#8f0752" }}
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
